  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4">
        <a id="modalBigProject" class="portfolio-item d-block mx-auto" href="#portfolio-modal-1">
      ...
      <div class="col-md-6 col-lg-4">
        <a id="modalMediumProject" class="portfolio-item d-block mx-auto" href="#portfolio-modal-2">
          <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
            <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
              <i class="fa fa-search-plus fa-3x"></i>
            </div>
      ...
      <div class="col-md-6 col-lg-4">
        <a id="modalSmallProject" class="portfolio-item d-block mx-auto" href="#portfolio-modal-3">
          <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
            <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
              <i class="fa fa-search-plus fa-3x"></i>
            </div>
